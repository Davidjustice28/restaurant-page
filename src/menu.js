...
function menuScreen() {
    ...
    //create sections for container structure
    ...
    const special1 = item("Shrimp Scampi", "Atlantic Shrimp, pasta, and butter.", "24");
    const special2 = item("Chicken Parmesean", "Chicken breast, cheese, and pasta.", "19");
    const special3 = item("Lasagna", "Ground beef, cottage cheese, and pasta.", "15");
    specials.push(special1, special2, special3);
    

    const app1 = item("Fried Zucchini", "Breadcrumbs, zucchini, and eggwash.", "7");
    const app2 = item("Cheesesteak Eggrolls", "Steak, onions, and peppers.", "10");
    const app3 = item("Potstickers", "Wonton wraps, ground beef, and carrots.", "8");
    appetizers.push(app1, app2, app3);


    const entree1 = item("Cheese Pizza", "Mozzarella, dough, and maranara.", "15");
